...
The analysis code, manuscript source, figures, tables, and non-identifying reproducibility materials for the final analysis are prepared for archival through Zenodo; the version-specific DOI for release v1.1.0 will be inserted before submission. The public project repository is available at \href{https://github.com/chy010321/next-day-readiness-womens-football}{GitHub}. The original SoccerMon data must be downloaded separately from Zenodo and are not redistributed in the code archive.
